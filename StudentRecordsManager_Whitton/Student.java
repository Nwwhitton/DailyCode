...
public class Student {
    ...
    private double calculateAverage() {
        ...
        return sum / this.grades.length; // Placeholder return
    }
    ...
    public String toString() {
        ...
        output.append("\nAverage Grade: ").append(String.format("%.2f", this.averageGrade));
        output.append("\nLetter Grade: ").append(this.letterGrade);
        return output.toString(); // Placeholder return
    }
}
